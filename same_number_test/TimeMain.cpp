...
/*		
	...
	cout << "***\ttotal Producer actions are "<<totalNumMpScQueueAction.load()<<" frequency\t***"<< endl;
	cout << "***\ttotal Consumer actions are "<<NumDeq<<" frequency\t***"<< endl;
	cout << "***\ttotal Consumer failed are "<<FailDeq<<" frequency\t***"<< endl;
	cout << "***\ttotal Consumer success number is "<<(NumDeq-FailDeq)<<" frequency\t***"<< endl;
	cout << "***\ttotal actions are "<<total_actions<<" frequency\t***"<< endl;
