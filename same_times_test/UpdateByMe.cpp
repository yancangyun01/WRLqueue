...
void testMyqueue(int num_threads){
    ...
    printf("***\ttotal Producer failed are %ld frequency\t***\n",FailEnq/running_time);
    printf("***\ttotal Producer success number is %ld frequency\t***\n",(NumEnq-FailEnq)/running_time);
    printf("***\ttotal Consumer actions are %ld frequency\t***\n",NumDeq/running_time);
    printf("***\ttotal Consumer failed are %ld frequency\t***\n",FailDeq/running_time);
    printf("***\ttotal Consumer success number is %ld frequency\t***\n",(NumDeq-FailDeq)/running_time);
